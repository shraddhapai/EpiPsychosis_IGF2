...
METHRATIO=/home/g/gbader/spai/software/bsmap-2.74/methratio.py
PICARD=/home/g/gbader/spai/software/picard.jar #picard-tools-1.98/picard-1.98.jar
SAMTOOLS=samtools
BAMUTIL=/home/g/gbader/spai/software/bamUtil/bin/bam
BEDTOOLS=/home/g/gbader/spai/software/bedtools2/bin/bedtools
BGZIP=/home/g/gbader/spai/software/usr/local/bin/bgzip
TABIX=/home/g/gbader/spai/software/usr/local/bin/tabix
hg38_fa=/home/g/gbader/spai/genome_annotation/grch38/fasta/hg38NoAlt_Lambda.fa
hg38_chromSizes=/home/g/gbader/spai/genome_annotation/grch38/hg38.chrom.sizes
primaryTargets=/scratch/g/gbader/spai/Epigenetics/NARSAD/input_files/SeqCapEpi2/OID43737_hg19_161128_design_deliverables/OID43737_hg19_161128_primary_targets.hg38.bed
captureTargets=/scratch/g/gbader/spai/Epigenetics/NARSAD/input_files/SeqCapEpi2/OID43737_hg19_161128_design_deliverables/OID43737_hg19_161128_capture_targets.hg38.bed
...
### ----------------------------------------------------
	...
	$SAMTOOLS view -H ${sampName}_L000.bam > ${baseF}.header.txt
	$SAMTOOLS view -S ${sampName}_L000.bam | grep "ZS:Z:+" > ${baseF}.top.sam.tmp
 	cat ${baseF}.header.txt ${baseF}.top.sam.tmp > ${baseF}.top.sam

	$SAMTOOLS view -S ${sampName}_L000.bam | grep "ZS:Z:-" > ${baseF}.bottom.sam.tmp
...
### ----------------------------------------------------
	...
	$SAMTOOLS sort ${baseF}.CLEAN.bam -o ${baseF}.tmp.bam
...
python $METHRATIO -d $hg38_fa -m 1 -z -i skip -o ${baseF}.methylation_results.txt ${baseF}.CLEAN.bam
###
module load gcc
module load samtools
