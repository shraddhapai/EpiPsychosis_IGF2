...
inDir <- "/home/shraddhapai/Epigenetics/NARSAD/output_files/SeqCap2/methylation"
outDir <- "/home/shraddhapai/Epigenetics/NARSAD/output_files/SeqCap2/methylation/locuswise"
...
# Label target groups
target_groups <- c("NEURODEV","scz2_plt0.0001.CTCF",
	"scz2_plt0.0001.EnhProm")#,"Adol_Reg", "AdolEPIC") #,"CaseControl") #,"chrX") # "CaseControl"
...
targets <- subset(targets, group %in% target_groups) #"CaseControl")
