...
###bspan2 <-sapply(names(bspan),function(x) cbind(x,bspan[[x]]))
###bspan2 <- do.call("rbind",bspan2)
###write.table(bspan2,file="BSpan_neurodev_groups.txt",sep="\t",col=F,row=F,quote=F)
